# Sensitivity Analysis and Steady State PK Comparison for PFOS #
...
one   <- dynamic(230,0.00039,40.1379854360056,71.3)
two   <- dynamic(300,0.00039,40.1379854360056,71.3)
three <- dynamic(3000,0.00039,40.1379854360056,71.3)
